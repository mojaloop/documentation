...
3. Runs the Build step
  ...
  * 3. Sets up the license scanner
  * 4. Creates a new docker container from the built docker image, and copies across the `node_modules` directory
  * 5. Runs the license scanner tool against the copy of the `node_modules` directory
  * 6. Publishes the docker image
  * 7. Sends a slack announcement about the new release


[todo: insert master/release flow]
