...
| Name | Type | Mandatory<br>(Y/N) | Description | Example |
| --- | --- | --- | --- | --- |
...
| metadata | object \<ObMetadataType\> | N | The sender should avoid to use this property to transport any kind of content-related information, but merely data relevant to the context of the communication. Consider to define a new content type if there's a need to include more content information into the message. | |
...
| action | enum \<LogEventAction, AuditEventAction, TraceEventAction, ErrorEventAction, NullEventAction\> | Y | Type of action. | [ `start`, `end` ] |
...
| state | string \<EventStateMetadata\> | Y | Object describing the state. |  |
