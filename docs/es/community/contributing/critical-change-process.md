---
i18n_source_sha: e2ea9a95cf6c62978d0525610038845a43e853df
---

# Proceso de cambios críticos

_**En Mojaloop, el "proceso de cambios críticos" es similar al "proceso de cambios con consecuencias", pero con supervisión
adicional y con la exigencia de una aprobación formal, dado el carácter de alto riesgo que tienen esos cambios en nuestro entorno operativo.**_

Para los cambios que entran en la [definición de cambio crítico](./design-review.md#cambios-criticos), se debe seguir el
siguiente proceso:
...
2. Proponga cambios de código a la Mojaloop Design Authority:
    1. Cree un problema de tipo 'Critical Change Proposal' en el repositorio del proyecto 'design-authority-project'
    ...
    2. Envíe un mensaje al canal de slack [#design-authority](https://mojaloop.slack.com/archives/CARJFMH3Q) pidiendo
       una revisión de su propuesta.
    3. La design authority asignará a dos o más miembros para trabajar con usted en su propuesta.
3. Participe en una revisión de diseño:
    1. Los miembros de la design authority que se le asignen le guiarán por un proceso iterativo de revisión de diseño.
    2. Una vez completado el proceso de revisión de diseño, los miembros de la design authority asignados aprobarán formalmente su
       diseño para que comience la implementación
    3. Una vez que su diseño haya sido aprobado formalmente, puede continuar con su cambio.
4. Implemente y revise sus cambios de código:
    1. Cree elementos de trabajo en github/zenhub y trabaje en ellos, dentro de
       ...
       hacer referencia al ticket del product council y al ticket de la propuesta de cambio crítico en las descripciones de sus elementos, para permitir
       la trazabilidad futura.
    2. Cuando esté listo para hacer pull requests en uno o varios repositorios de código, contacte con los miembros de la design authority
    ...
    4. Una vez que los miembros de la design authority asignados aprueben sus pull requests, su funcionalidad está lista para incluirse en
       el proceso oficial de versiones de Mojaloop.
    5. Los miembros de la design authority asignados registrarán formalmente su revisión de aprobación de sus pull requests.
    6. Todo cambio en el diseño que se haga durante la implementación debe registrarse en el ticket de la propuesta.

![Proceso de cambios críticos](./assets/critical-change-process.jpg)
...
Los miembros de la design authority que se le asignen le ayudarán a identificar y mitigar cualquier riesgo que su cambio pueda introducir, además
...
2. Los miembros de la design authority que se le asignen le ayudarán a identificar a cualquier otro contribuyente, equipo o
...
3. El objetivo principal de los miembros de la Design Authority que se le asignen es identificar y mitigar riesgos que usted quizá no haya
   detectado.
    1. Los miembros de la design authority que se le asignen pueden hacer sugerencias para mitigar el riesgo de su diseño y pueden pedirle
