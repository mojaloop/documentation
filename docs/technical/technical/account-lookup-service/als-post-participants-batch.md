...
- Operation only supports requests which contain:
    ...
    - All Participant's will be of the same Currency, per the `POST /participants` call in the [Mojaloop FSPIOP API](/technical/api/fspiop/v1.1/api-definition.html#post-participants)  
