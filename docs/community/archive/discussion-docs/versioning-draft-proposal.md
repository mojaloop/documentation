...
4. Helm
    ...
    * PI (Program Increment) + Sprint based versioning.
    > _Note:_ _PI + Sprint based versioning_ make sense in the context of the current Mojaloop Program Increments, but will need to be revised at a later date.
...
| **APIs** | | | |
| - FSPIOP API | CCB | _x.y_ | Major.Minor |
| - Settlement API | CCB | _x.y_ | Major.Minor |
| - Admin/Operations API | CCB | _x.y_ | Major.Minor |
| Helm | Design Authority  | _x.y.z_ | PI.Sprint.Increment |
| **Internal Schemas** | | | |
| - DB Schema | Design Authority | _x.y_ | Major.Minor |
| - Internal Messaging | Design Authority | _x.y_ | Major.Minor |
...
| **APIs** | | | |
| - FSPIOP API | CCB | _1.0_ |
| - Settlement API | CCB | _1.1_ |
| - Admin/Operations API | CCB | _1.0_ |
| Helm | Design Authority  | _9.1.0_ |
| **Internal Schemas** | | | |
| - DB Schema | Design Authority | _1.0_ |
| - Internal Messaging | Design Authority  | _1.0_ |
