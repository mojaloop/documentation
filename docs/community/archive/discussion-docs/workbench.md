...
__Level 1:__ Running a Mojaloop switch (e.g. Hub Operators)  
__Level 2:__ Interacting with a Mojaloop Switch directly (e.g. DFSPs, Systems Integrators)  
__Level 3:__ Interacting with a DFSP over a Mojaloop Switch (e.g. Fintechs)  
...
__7.2.2 Examples from our user personas:__
...
__7.2.3 Outputs: (How can the Mojaloop OSS Community better serve these players?)__
...
__7.2.4 Inputs: (what are the things that we need to do to meet these goals)__
...
__7.3.2 Examples from our user personas:__
...
__7.3.3 Outputs: (How can the Mojaloop OSS Community better serve these players?)__
...
__7.3.4 Inputs: (what are the things that we need to do to meet these goals)__
