...
* Un ensemble standardisé d’interfaces qu’un DFSP peut mettre en œuvre pour se connecter au système, ainsi que des exemples de code montrant comment utiliser le système. Un DFSP souhaitant se connecter peut adapter notre exemple de code ou implémenter les interfaces standardisées dans son propre logiciel. L’objectif est de rendre la connexion au réseau d'interopérable aussi simple que possible pour un DFSP.
