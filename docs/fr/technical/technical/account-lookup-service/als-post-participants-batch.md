...
- L’opération ne prend en charge que les requêtes où :
    ...
    - tous les participants partagent la même devise, conformément à l’appel `POST /participants` de l’[API FSPIOP Mojaloop](/fr/technical/api/fspiop/v1.1/api-definition.html#post-participants)
