---
sidebarTitle: Workstream déploiement
---
...
Une suite d’outils bien documentée et complète, permettant d’explorer, développer, tester, évaluer et exploiter le logiciel, est essentielle à la pérennité des SIIP basés sur Mojaloop.

L’objectif est de permettre un déploiement simple, dans l’environnement de choix, avec un minimum d’appui de la communauté.
