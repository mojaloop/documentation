...
Le parcours d'onboarding des DFSP comprend des étapes qui se déroulent en dehors du Hub Mojaloop. Elles sont liées au volet métier de l'onboarding, et il est utile pour l'opérateur du Hub d'en être informé.

::: tip NOTE
Les étapes du processus de candidature du DFSP et du parcours d'onboarding métier sont définies par le schéma, en conformité avec les exigences réglementaires financières locales.
:::

Les étapes clés du parcours d'onboarding métier sont :
...
1. La documentation est partagée avec le DFSP, ce qui permet au DFSP d'évaluer l'effort technique d'onboarding, ainsi que sa compatibilité commerciale avec les règles de schéma.
...
En parallèle des étapes métier, après la signature de l'accord de participation, le DFSP peut commencer son [parcours d'onboarding technique](technical-onboarding.md).
