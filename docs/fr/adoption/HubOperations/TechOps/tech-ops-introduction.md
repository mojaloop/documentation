...
- [**Gestion des versions**](./release-management.md) : Gestion, planification, programmation et contrôle d'une modification logicielle à travers le déploiement et les tests dans divers environnements.

- [**Triage des défauts**](./defect-triage.md) : S'assurer que tous les bogues identifiés dans l'environnement de production du client sont capturés, évalués, priorisés et soumis au Service Desk.
...
- **Recette (STG)** : Environnement de recette qui reflète la production aussi fidèlement que possible. Validation des nouvelles versions et de l'onboarding des DFSP.

- **Production (PRD)** : Environnement de production compatible avec la release en production.
