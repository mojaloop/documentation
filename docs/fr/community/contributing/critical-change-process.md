...
_**Pour Mojaloop, le « processus des changements critiques » est proche du processus des changements conséquents, avec une supervision renforcée et une validation formelle, compte tenu du risque élevé de ces changements dans notre environnement d’exploitation.**_
...
3. Participer à une revue de conception :
    ...
    2. À l’issue, ils valident formellement la conception pour démarrer l’implémentation.
...
4. Implémenter et faire revue du code :
    ...
    5. Les membres assignés enregistrent formellement leur approbation sur les PR.
    6. Toute évolution de la conception pendant l’implémentation doit être consignée sur le ticket de proposition.
