...
[Standards de documentation](https://github.com/mojaloop/mojaloop/blob/master/contribute/Documentation-and-Template-Standards.md)
...
Nous suivons les [standard style guidelines](https://github.com/feross/standard). Ajoutez `npm install standard` à votre package.json.

#### Java

Pour Java, nous suivons [Checkstyle](http://checkstyle.sourceforge.net/). Mesures de qualité du code
